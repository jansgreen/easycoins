...
class BuyForm(forms.Form):
    ...
    Have_Symbols= forms.ModelChoiceField(queryset=Coins.objects.all().order_by('Symbol'), empty_label="I have...", widget=forms.Select(attrs={'class':'btn btn-outline-secondary dropdown-toggle', 'type': 'button', 'data-bs-toggle': 'dropdown', 'aria-expanded': 'false'}))
